                                ...
                                <ol class="mb-0 breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">
                                        @if(auth()->user()->hasRole('Staff'))
                                            {{auth()->user()->name}} Course Allocation
                                        @else
                                            List of Saved Departmental Allocated Courses
                                        @endif
                                    </li>
                                </ol>
                    ...
                    @if (Gate::allows('Administrator', auth()->user()))
                        ...
                        <div class="dt-card">
                            ...
                            <div class="dt-card__body">
                                ...
                                <form action="{{route('allocation.save')}}" method="POST" enctype="multipart/form-data">
                                    {{ csrf_field() }}
                                    <div class="form-row">
                                       ...
                                       <div class="col-sm-4 mb-4">
                                            ...
                                            <select name="user_id" class="form-control" required>
                                                <option> -- Select The Lecturer -- </option>
                                                <option value=""></option>
                                        ...
                                        <div class="col-sm-4 mb-4">
                                            <label for="validationDefault02">Update Allocate Course</label>
                                            <button class="btn btn-primary btn-lg btn-block text-uppercase" type="submit">Allocate The Course</button>
                                        </div>
                                    </div>
                        ...
                        <div class="dt-card__body">
                            @if(count($allocation) ==0)
                                <p align="center" style="color: red"><i class="icon icon-table"></i>
                                    @if(auth()->user()->hasRole('Staff'))
                                        {{auth()->user()->name}} Your Course Allocation is Empty
                                    @else
                                        The Course Allocation List is Empty
                                    @endif
                                            ...
                                            @foreach ($allocation as $allocations)
                                                <tr class="gradeX">
                                                    <td>{{$y}}
                                                        ...
                                                        @endif
                                                        @if (auth()->user()->hasRole('Staff'))
                                                            <a href="{{route('assignment.create', $allocations->allocation_id)}}"
                                                                class="" onclick="">
