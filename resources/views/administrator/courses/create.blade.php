                            ...
                            <div class="dt-card">
                                ...
                                <ol class="mb-0 breadcrumb">
                                    ...
                                    @if (auth()->user()->hasPermissionTo('Add Course') OR
                                        ...
                                        <li class="breadcrumb-item"><a href="{{route('course.create')}}">View Course</a></li>
                                    @endif
                        ...
                        <div class="dt-card">
                            ...
                            <div class="dt-card__header">
                                ...
                                <div class="dt-card__heading">
                                    <h3 class="dt-card__title">Course Registration Form</h3>
                                </div>
                                <!-- /card heading -->
                                    ...
                                    <div class="form-row">
                                        <div class="col-sm-4 mb-3">
                                            ...
                                            <input type="text" class="form-control" id="validationDefault01"
                                                placeholder="Enter Course Title" required name="course_title" value="{{old('course_title')}}">
                                        ...
                                        <div class="col-sm-4 mb-3">
                                            ...
                                            <input type="text" class="form-control" id="validationDefault01"
                                                placeholder="Enter Course Code" required name="course_code" value="{{old('course_code')}}">
                                        ...
                                        <div class="col-sm-4 mb-3">
                                            ...
                                            <input type="number" class="form-control" id="validationDefault01"
                                                placeholder="Enter Course Unit" required name="course_unit" value="{{old('course_unit')}}">
                                        ...
                                        <div class="col-sm-6 mb-3">
                                            ...
                                            <select name="course_status" class="form-control" required>
                                                ...
                                                <option>{{old('course_status')}}</option><?php
                                        ...
                                        <div class="col-sm-6 mb-3">
                                            ...
                                            <input type="file" class="form-control" id="validationDefault01"
                                                placeholder="" required name="course_file" value="{{old('course_file')}}">
                                        ...
                                        <div class="col-sm-12 mb-3">
                                            <button class="btn btn-primary btn-lg btn-block text-uppercase" type="submit">Add The Course</button>
                                        </div>
                                    </div>
