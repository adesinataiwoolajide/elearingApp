                                    ...
                                    <div class="form-row">
                                        <div class="col-sm-3 mb-3">
                                            ...
                                            <input type="text" class="form-control" id="validationDefault01"
                                                name="course_title" value="{{$allocation->course->course_title}}" readonly>

                                        </div>
                                        <div class="col-sm-2 mb-3">
                                            <label for="validationDefault02"> Code</label>
                                            <input type="text" class="form-control" id="validationDefault01"
                                                name="course_code" value="{{$allocation->course->course_code}}" readonly>
                                        ...
                                        <div class="col-sm-2 mb-3">
                                            ...
                                            <input type="number" class="form-control" id="validationDefault01"
                                                placeholder="Enter Marks" max="30"  value="{{$assignment->marks}}" required name="marks">
                                            @if ($errors->has('marks'))
                                        ...
                                        <div class="col-sm-2 mb-3">
                                            ...
                                            <div class="input-group date" id="date-time-picker-1"
                                                ...
                                                <input type="text" class="form-control datetimepicker-input" value="{{$assignment->submission_date}}"
                                        ...
                                        <div class="col-sm-12 mb-3">
                                            ...
                                            <textarea class="" id="summernote" name="question" required placeholder="Assignment Content Here" style="height:20px">
                                                {{$assignment->question}}
                                            </textarea>
                                        ...
                                        <div class="col-sm-12 mb-3">
                                            <button class="btn btn-primary btn-lg btn-block text-uppercase" type="submit">Update The Assignment</button>
                                        </div>
                                    </div>
